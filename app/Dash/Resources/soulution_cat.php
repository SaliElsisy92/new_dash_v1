...
class soulution_cat extends Resource {

	/**
	 * define Model of resource
	 * @param Model Class
	 */
	public static $model = \App\Models\Soulution_cat::class ;
	 ...
	 */
	public static $group = 'soulution_cat';
	...
	public function fields() {
		return [
            ...
            text() ->make(__('dash::dash.name'), 'name')
                ...
                ->columnWhenCreate(6)
                ->showInShow(),
            image()->make(__('dash::dash.image'), 'photo')
                ->path('solutions/{id}')
                ->column(6)
