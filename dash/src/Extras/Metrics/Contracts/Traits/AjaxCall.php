...
trait AjaxCall{
    ...
    public function prepareAjaxCall($classname,$model,$typeCalc,$sumColumn,$at,$query='',$query_format=''){
        ...
        $ajax .= "<input type='hidden' class='query_".$classname."' value='".htmlspecialchars($query)."'/>";
        $ajax .= "<input type='hidden' class='query_format_".$classname."' value='".htmlspecialchars($query_format)."'/>";
        return $ajax;
    }
}
